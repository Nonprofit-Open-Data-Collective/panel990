...
# The published release is CSV-only until the parquet build is uploaded; flip
# this to "parquet" once it is, and every caller that does not name a format
# follows.
.EFILE_FORMAT <- "csv"
...
#'
#' A read loop should open one connection and pass it down rather than let each
